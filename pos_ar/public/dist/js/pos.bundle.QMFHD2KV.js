(() => {
  ...
  pos_ar.PointOfSale.pos_selected_item_cart = class {
    ...
    prepare_selected_item_cart() {
      ...
      this.buttonsContainer.append('<button id="key_quantity" class="grid-item"  data-action="Quantity" > Quantit\xE9  </button>');
...
//# sourceMappingURL=pos.bundle.QMFHD2KV.js.map
