  ...
  pos_ar.PointOfSale.pos_history = class {
    ...
    async print_receipt(pos, status) {
      ...
      try {
        ...
        console.log("test2");
        let previous_balance = (_a = customer.custom_debt) != null ? _a : 0;
        if (this.app_settings.settings.onlineDebt) {
          ...
          try {
            ...
            previous_balance = (_b = result.message) != null ? _b : 0;
...
Previous balance: ${previous_balance}`);
  ...
  pos_ar.PointOfSale.pos_item_details = class {
    constructor(wrapper, warehouse, priceLists, itemPrices, selectedItem, selectedField, onInput, onClose) {
      this.wrapper = wrapper;
...
//# sourceMappingURL=pos.bundle.IHXUSJOH.js.map
